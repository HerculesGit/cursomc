...
import com.herco.cursomc.domain.Pedido;
...
import com.herco.cursomc.repositories.CidadeRepository;
...
public class CursomcApplication implements CommandLineRunner { // para usar uma linha de comando ao de iniciar 
	...
	public void run(String... args) throws Exception {
		...
		Endereco e2 = new Endereco(null, "Avenida Maos", "Sala 800", "105", "Centro", "38777012", cli1, c2);
